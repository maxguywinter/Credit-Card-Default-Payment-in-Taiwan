...
o	LIMIT_BAL: The amount of the given credit (NT dollar): it includes both the individual consumer credit and his/her family (supplementary) credit
o	SEX (1 = male; 2 = female)
o	EDUCATION (1 = graduate school; 2 = university; 3= high school; 4 = others)
o	MARITAL SATUS (1 = married; 2 = single; 3 = others)
o	AGE (year).
o	PAY0: Repayment status in September, 2005 (-1=pay duly, 1=payment delay for one month, 2=payment delay for two months,8=payment delay for eight - months, 9=payment delay for nine months and above)
...
o	BILLAMT1: Amount of bill statement in September, 2005 (NT dollar)
...
o	PAYAMT1: Amount of previous payment in September, 2005 (NT dollar)
